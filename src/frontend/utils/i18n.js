...
const translations = reactive({
  en: {
    ...
    expireNotificationTime: 'Expiration Notification Time',
    expireNotificationTimeTip: 'Expiration reminders are checked by the hourly cron at this hour in the notification timezone.',
    invalidNotificationTimezone: 'Notification timezone must be a valid IANA timezone, for example Asia/Shanghai.',
    invalidExpireNotificationTime: 'Expiration notification time must be an hourly HH:00 value.',
  ...
  zh: {
    ...
    expireNotificationTime: '到期通知时间',
    expireNotificationTimeTip: '到期提醒由每小时定时任务按通知时区在这个整点小时检查。',
    invalidNotificationTimezone: '通知时区必须是有效 IANA 时区，例如 Asia/Shanghai。',
    invalidExpireNotificationTime: '到期通知时间必须是整点 HH:00。',
    saveConfig: '保存配置',
    saving: '保存中...',
    hostnameLabel: '主机名',
    groupName: '分组名称',
